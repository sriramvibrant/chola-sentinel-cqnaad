...
# Autoencoder & NV sim functions (same as before)
...
endpoints_input = st.text_area("Endpoints (one per line)", value="https://www.google.com\nhttps://portal.azure.com\nhttps://aws.amazon.com", height=100)
